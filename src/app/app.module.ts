...
const appRoutes: Routes = [
  ...
  { path: 'home/genero/cancion', component: CancionComponent },
  { path: 'buscar', component: BuscarComponent },
  { path: 'buscar/lista', component: ListaComponent },
  { path: 'buscar/lista/cancion', component: CancionComponent },
  { path: 'buscar/artista', component: ArtistaComponent },
  { path: 'buscar/artista/album', component: AlbumComponent },
  { path: 'buscar/artista/album/cancion', component: CancionComponent },
  { path: 'buscar/album', component: AlbumComponent },
  { path: 'buscar/album/cancion', component: CancionComponent },
  ...
  { path: 'biblioteca/lista/cancion', component: CancionComponent, canActivate: [() => inject(LoginGuardian).canActivate()], },
  ...
  { path: 'biblioteca/artista/album/cancion', component: CancionComponent, canActivate: [() => inject(LoginGuardian).canActivate()], },
  { path: 'biblioteca/album', component: AlbumComponent, canActivate: [() => inject(LoginGuardian).canActivate()], },
  { path: 'biblioteca/album/cancion', component: CancionComponent, canActivate: [() => inject(LoginGuardian).canActivate()], },
