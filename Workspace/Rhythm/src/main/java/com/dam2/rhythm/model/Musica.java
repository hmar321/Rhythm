...
public class Musica {
	...
	public String toString() {
		return "Musica [id=" + id + ", titulo=" + titulo + ", albumes=" + albumes + ", listas=" + listas + ", generos="
				+ generos.size() + ", artista=" + artista.getNick() + ", estreno=" + estreno + ", generosCadena=" + getGenerosCadena() + "]";
	}

	private void actualizarGenerosCad() {
		StringBuffer cad = new StringBuffer();
		for (Genero genero : generos) {
			cad.append(", " + genero.getNombre());
		}
		generosCadena = cad.toString().replaceFirst(", ", "");
	}
}
